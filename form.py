...
beta_database = [
    ...
    {"username": "user8", "answers": ['B', 'C', 'B', 'A', 'B'], "classification": "half-zombie"},
    {"username": "user9", "answers": ['C', 'B', 'C', 'C', 'A'], "classification": "human"},
    {"username": "user10", "answers": ['A', 'C', 'A', 'A', 'B'], "classification": "zombie"},
